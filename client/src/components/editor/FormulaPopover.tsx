...
export default function FormulaPopover({ anchorEl, initialLatex, onSave, onClose }: FormulaPopoverProps) {
  ...
  const symbolCategories = {
    basic: [
      // Amallar
      { text: '+', label: '+', title: "Qo'shish" },
      { text: '-', label: '−', title: 'Ayirish' },
      { text: '\\cdot', label: '·', title: "Ko'paytirish" },
      { text: '\\div', label: '÷', title: "Bo'lish" },
      { cmd: '\\frac', label: '\u00B9/\u2093', title: 'Kasr' },
      { text: '=', label: '=', title: 'Teng' },
      { text: '\\neq', label: '≠', title: 'Teng emas' },
      // Daraja va indeks
      { text: '^', label: 'x\u207F', title: 'Daraja' },
      { text: '_', label: 'x\u2099', title: 'Pastki indeks' },
      { cmd: '\\sqrt', label: '\u221A', title: 'Ildiz' },
      { cmd: '\\nthroot', label: '\u207F\u221A', title: 'n-ildiz' },
      // Qavslar
      { text: '()', label: '( )', title: 'Qavslar' },
      { text: '[]', label: '[ ]', title: 'Kvadrat qavslar' },
      { text: '\\left\\{\\right\\}', label: '{ }', title: 'Jingalak qavslar' },
      { text: '||', label: '| |', title: 'Modul' },
      // Taqqoslash
      { text: '<', label: '<', title: 'Kichik' },
      { text: '>', label: '>', title: 'Katta' },
      { text: '\\leq', label: '≤', title: 'Kichik yoki teng' },
      { text: '\\geq', label: '≥', title: 'Katta yoki teng' },
      // Tez-tez ishlatiladigan
      { text: '\\%', label: '%', title: 'Foiz' },
      { text: '^{\\circ}', label: '\u00B0', title: 'Gradus' },
      { text: '\\infty', label: '∞', title: 'Cheksizlik' },
      { text: '\\pm', label: '±', title: 'Plyus-minus' },
      // Katta qavslar va murakkab
      ...
      { text: '\\begin{pmatrix}  \\\\  \\end{pmatrix}', label: '(\u2009)', title: 'Matritsa' },
    ],
    greek: [
